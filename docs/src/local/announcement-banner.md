...
```text
{% embed-ignore announcement-banner id="0.2.17-rc.10" message="*Version **0.2.17-rc.10** now has relased, check it out [here](https://github.com/MR-Addict/mdbook-embedify/releases/tag/0.2.17-rc.10).*" %}
```
